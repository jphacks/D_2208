...
export type CreateCustomPointersMutationVariables = Exact<{
  roomId: Scalars['ID'];
  id: Scalars['ID'];
  label: Scalars['String'];
  content: Scalars['String'];
...
export type CreateCustomPointersMutation = { __typename?: 'Mutation', createCustomPointer: string };
...
export type CreateCustomPointerMutationVariables = Exact<{
  roomId: Scalars['ID'];
  id: Scalars['ID'];
  label: Scalars['String'];
  content: Scalars['String'];
...
export type CreateCustomPointerMutation = { __typename?: 'Mutation', createCustomPointer: string };

export type ChangePointerTypeToSpotlightMutationVariables = Exact<{
  roomId: Scalars['ID'];
}>;


export type ChangePointerTypeToSpotlightMutation = { __typename?: 'Mutation', changePointerType: string };

export type DeleteCustomPointerMutationVariables = Exact<{
  roomId: Scalars['ID'];
  id: Scalars['ID'];
}>;


export type DeleteCustomPointerMutation = { __typename?: 'Mutation', deleteCustomPointer: string };
