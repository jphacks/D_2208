 ...
 *
 * The version of the OpenAPI document: 1.0.0_SNAPSHOT
 *
 *
...
export const RoomApiAxiosParamCreator = function (
  ...
  return {
    ...
    joinRoom: async (
      ...
      const localVarPath = `/api/rooms/{room_id}/join`.replace(
        `{${"room_id"}}`,
...
export const RoomApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createRoom(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<RoomResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createRoom(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
...
export const RoomApiFactory = function (
  ...
  return {
    ...
    joinRoom(
      ...
      return localVarFp
        .joinRoom(roomId, roomJoinRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
